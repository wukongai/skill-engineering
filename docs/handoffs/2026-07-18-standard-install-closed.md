...
状态：`installer_entry_closed`；完整 Agent Skill-only 验收仍为 release blocker

日期：2026-07-18

PM 独立复核：PASS；安装文档/installer entry 子任务可以关闭，未关闭整个 1.0 发布任务。
...
下一窗口先读取本 handoff、`docs/guides/licensing-and-installation.md`、`docs/architecture.md` 和 `docs/BACKLOG.md`，再为 runtime/bootstrap 建立独立 Spec/Plan。不要在该任务中重新讨论 clone 是否属于普通用户首选路径。
