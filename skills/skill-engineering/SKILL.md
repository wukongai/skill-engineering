...
1. 先识别意图:create、improve、evolve、audit、evaluate、govern、install、inventory 或 resume。
...
- 已确认创建或正在维护的复杂、生产、商业或多版本 Skill:读取 `references/development-governance.md` 与 `stages/project-governance/INSTRUCTIONS.md`;再盘点 Product、Architecture、Roadmap、Backlog、Task、Spec、Plan、ADR、Sprint、Daily Log、Version 和 Changelog 的等价事实源。简单 Skill 保持轻量,不要强塞完整项目模板。
...
- 商业/工业级或多版本 Skill 没有产品边界、架构事实源、版本计划或当前验收标准。
