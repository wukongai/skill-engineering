...
5. 本仓库原创代码、Skill 指令和文档默认按 Apache License 2.0 发布；除非明确声明并获项目接受，贡献也按 Apache-2.0 进入项目。提交者必须拥有贡献内容的权利，不得提交未标注来源的第三方材料。
...
- 不把 Apache-2.0 误写成品牌授权、强制前台署名、强制开源衍生作品或托管服务条款；
- 不把结构分数表述为真实下游效用。
